...
ALTER TABLE um_additionalid ADD COLUMN updatetype integer;
ALTER TABLE um_additionalid ALTER COLUMN updatetype SET STORAGE PLAIN;
ALTER TABLE um_additionalid ALTER COLUMN updatetype SET DEFAULT 0;
ALTER TABLE um_additionalid ADD COLUMN logintype integer;
ALTER TABLE um_additionalid ALTER COLUMN logintype SET STORAGE PLAIN;
ALTER TABLE um_additionalid ALTER COLUMN logintype SET DEFAULT 0;
ALTER TABLE um_additionalid ADD COLUMN validdate date;
ALTER TABLE um_additionalid ALTER COLUMN validdate SET STORAGE PLAIN;
ALTER TABLE um_additionalid ADD COLUMN invaliddate date;
ALTER TABLE um_additionalid ALTER COLUMN invaliddate SET STORAGE PLAIN;

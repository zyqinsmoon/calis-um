-- 标识生成相关
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.common.ejb.manage.perm.ResourceType', 0, 'rt', false, 'nj-ums', 0)
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.common.ejb.manage.perm.Operation', 0, 'op', false, 'nj-ums', 0)
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.common.ejb.manage.perm.DelegateAuth', 0, 'da', false, 'nj-ums', 0)


insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.common.ejb.manage.spec.SpecDataItem', 0, 'sdi', false, 'nj-ums', 0)
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.common.ejb.manage.spec.I18nValue', 0, 'iv', false, 'nj-ums', 0)
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.common.ejb.manage.spec.DataType', 0, 'dt', false, 'nj-ums', 0)
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.common.ejb.manage.spec.SpecBaseInfo', 0, 'sbi', false, 'nj-ums', 0)

insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.um.ejb.entity.statistics.LogItem', 0, 'li', false, 'nj-ums', 0)


insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.um.ejb.entity.env.IPSegment', 0, 'ips', false, 'nj-ums', 0)
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.um.ejb.entity.env.IPRange', 0, 'ipr', false, 'nj-ums', 0)
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.um.ejb.entity.perm.Application', 0, 'app', false, 'nj-ums', 0)

insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.um.ejb.entity.perm.GeneralResource', 0, 'gr', false, 'nj-ums', 0)
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.um.ejb.entity.perm.Role', 0, 'rl', false, 'nj-ums', 0)
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.um.ejb.entity.perm.LegacyRole', 0, 'lrl', false, 'nj-ums', 0)
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.um.ejb.entity.perm.UserRule', 0, 'ur', false, 'nj-ums', 0)
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.um.ejb.entity.perm.PermissionRule', 0, 'pr', false, 'nj-ums', 0)
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.um.ejb.entity.usr.Organization', 0, 'org', false, 'nj-ums', 0)
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.um.ejb.entity.usr.UMPrincipal', 0, 'ump', false, 'nj-ums', 0)    
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.um.ejb.entity.usr.AdditionalId', 0, 'uai', false, 'nj-ums', 0) 

insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.um.ejb.entity.usr.Contactor', 0, 'ctr', false, 'nj-ums', 0)    
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.um.ejb.entity.usr.AuthCenter', 0, 'acr', false, 'nj-ums', 0)    
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.um.ejb.entity.usr.Card', 0, 'cd', false, 'nj-ums', 0)    
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.um.ejb.entity.usr.UserApplyForm', 0, 'uaf', false, 'nj-ums', 0)    
insert into seq_entityidgenerator(ENTITYNAME, VERSION, ENTITYPREFIX, DIRTY, SYSTEMPREFIX, SEQUENCE) values('com.cnebula.um.ejb.entity.usr.Personality', 0, 'pny', false, 'nj-ums', 0)    

-- 根角色和admin用户

insert into um_principle(id, usertype, name, loginId, password ,  sex, msgtype, status, validdate, invaliddate, creator, lastmodifier, version, lifecyclestatus, checkOrgIp) values ('$administrator', 3, '超级管理员', 'administrator', 'administrator',   'm', 4, 2,  TO_DATE( '10050701', 'YYYYMMDD' ),  TO_DATE( '30050701', 'YYYYMMDD' ), '$system', '$system', 1, 1, false)

insert into um_permissionrule(id, name, expression, type, enabled, operations, creator, lastmodifier, version, lifecyclestatus, authable) values('$admin_rule_p', '系统超级管理员权限规则', 'true',  0, true, '' , '$system', '$system', 1, 1, false)
insert into um_userrule(id, name, expression, type, enabled, operations, creator, lastmodifier, version, lifecyclestatus, authable) values('$admin_rule_u', '系统超级管理员用户规则', 'u.id="$administrator"',  0, true, '', '$system', '$system', 1, 1, false)
insert into um_role(id, dtype, enabled, name, type, creator, lastmodifier, version, lifecyclestatus) values('$admin_role', 'Role', true, '系统超级管理员角色', 1, '$system', '$system', 1, 1)
...
insert into um_permissionrule(id, name, entitylimittype, expression, type, enabled, operations, creator, lastmodifier, version, lifecyclestatus, authable) values('$loginservice_rule_p'  , '登录服务权限规则',      'com.cnebula.common.security.auth.ILoginService'         , null,  0, true, '', '$system', '$system', 1, 1,false)
insert into um_permissionrule(id, name, entitylimittype, expression, type, enabled, operations, creator, lastmodifier, version, lifecyclestatus, authable) values('$crudservice_rule_p'   , '实体访问服务权限规则',  'com.cnebula.common.ejb.manage.IEntityCRUDService'       , null,  0, true, '', '$system', '$system', 1, 1,false)
insert into um_permissionrule(id, name, entitylimittype, expression, type, enabled, operations, creator, lastmodifier, version, lifecyclestatus, authable) values('$1i8nremote_rule_p'    , '远程国际化服务权限规则','com.cnebula.common.i18n.I18nRemoteAccessService'        , null,  0, true, '', '$system', '$system', 1, 1,false)
insert into um_permissionrule(id, name, entitylimittype, expression, type, enabled, operations, creator, lastmodifier, version, lifecyclestatus, authable) values('$authservice_rule_p'   , '授权服务权限规则',      'com.cnebula.common.security.auth.IAuthorizationService' , null,  0, true, '', '$system', '$system', 1, 1,false)
insert into um_permissionrule(id, name, entitylimittype, expression, type, enabled, operations, creator, lastmodifier, version, lifecyclestatus, authable) values('$remotediscover_rule_p', '远程服务发现权限规则',  'com.cnebula.common.remote.IRemoteServiceDiscoverer'     , null,  0, true, '', '$system', '$system', 1, 1,false)
insert into um_permissionrule(id, name, entitylimittype, expression, type, enabled, operations, creator, lastmodifier, version, lifecyclestatus, authable) values('$webconfigservice_rule_p', 'web配置查询服务', 'com.cnebula.um.client.service.WebSiteConfigService'    , null,  0, true, '', '$system', '$system', 1, 1,false)

--认证的校验接口
insert into um_permissionrule(id, name, entitylimittype, expression, type, enabled, operations, creator, lastmodifier, version, lifecyclestatus, authable) values('$loginvalidatorservice_rule_p', '认证校验服务', 'com.cnebula.common.security.auth.ILoginValidateService'    , null,  0, true, '', '$system', '$system', 1, 1,false)


insert into um_userrule(id, name, expression, type, enabled, operations, creator, lastmodifier, version, lifecyclestatus, authable) values('$anonymous_rule_u', '系统匿名用户规则', 'true',  0, true, '', '$system', '$system', 1, 1,false)
insert into um_role(id, umroleowner_id, umroleparent_id, dtype, enabled, name, type, creator, lastmodifier, version, lifecyclestatus) values('$anonymous_role', '$administrator', '$admin_role', 'Role', true, '系统最低权限用户角色', 1,  '$system', '$system', 1, 1)
...
--insert into um_permissionrule(id, name, entitylimittype, expression, type, enabled, operations, creator, lastmodifier, version, lifecyclestatus, authable) values('$roleCreate_rule_p', '角色创建限制权限规则', 'com.cnebula.um.ejb.entity.perm.LegacyRole', 'uMRoleOwner != u',  0, true, 'create,update', '$system', '$system', 1, 1,false)
--insert into um_userrule(id, name, expression, type, enabled, operations, creator, lastmodifier, version, lifecyclestatus, authable) values('$roleCreate_rule_u', '角色创建限制用户规则', 'true',  0, true, '', '$system', '$system', 1, 1,false)
--insert into um_role(id, umroleowner_id, umroleparent_id, dtype, enabled, name, type, creator, lastmodifier, version, lifecyclestatus) values('$roleCreate_role', '$administrator', '$admin_role', 'Role', true, '角色创建限制角色', 0,  '$system', '$system', 1, 1)

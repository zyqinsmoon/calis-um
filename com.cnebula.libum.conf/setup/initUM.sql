...
ALTER TABLE UM_Resetpasswd ADD TENANT_ID VARCHAR2(255) NULL;
...
--简单授权服务接口权限授予
insert into um_permissionrule (ID, OPERATIONS, ENABLED, EXPRESSION, VERSION, NAME, TYPE, AUTHABLE, ENTITYLIMITTYPE, CREATETIME, LASTMODIFYTIME, LASTMODIFIER, CREATOR, DESCRIPTION, LIFECYCLESTATUS, TENANT_ID) values ('$ISimpleRoleService', '', 1, 'true', 1, 'ISimpleRoleService', 0, 0, 'com.cnebula.um.simple.permission.ISimpleRoleService',NULL, NULL, '$system', '$system', '', 4, '');

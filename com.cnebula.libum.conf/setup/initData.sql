...
insert into um_principle(id, usertype, name, loginId, localLoginId , password , sex, msgtype, status, validdate, invaliddate, creator, lastmodifier, version, lifecyclestatus, dtype, photo) values ('$administrator', 3, '超级管理员', 'administrator', 'administrator', 'administrator', 'm', 4, 2,  PARSEDATETIME( '10050701', 'YYYYMMDD' ),  PARSEDATETIME( '30050701', 'YYYYMMDD' ), '$system', '$system', 1, 1, 'UMPrincipal',RAWTOHEX(''));

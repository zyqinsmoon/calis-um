...
@Entity
@Table(name = "UM_HistoryCard")
@EntityUI(
		i18ns={
				@I18n(defaultLang="zh_CN", key="", items={@I18nLocale(lang="zh_CN", value="历史卡"), @I18nLocale(lang="en_US", value="Card")})
...
public class HistoryCard implements Maintainable, Serializable, ISaasable {
